...
const ProfileSummary = () => {
  return (
    <LazySection 
      id="profile-summary" 
      className="section-padding bg-gradient-to-br from-gray-50 to-blue-50 gpu-accelerated"
    >
            ...
            <div className="space-y-6 lg:space-y-8 order-2 lg:order-1">
              <div className="card animate-fade-in-up">
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
              ...
              <div className="card animate-fade-in-up" style={{animationDelay: '0.2s'}}>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-purple-500 to-pink-600 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <span className="text-white text-sm sm:text-base">🚀</span>
                  </div>
                  <div>
